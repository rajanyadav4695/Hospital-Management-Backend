...
import { addDepartmentController, deleteDepartmentController, getDepartmentController, updateDepartmentController } from '../Controller/AdminController/DepartmentController';
...
route.delete('/admin-delete-department/:id', verifyToken,deleteDepartmentController);
route.put('/admin-update-department/:id', updateDepartmentController);
